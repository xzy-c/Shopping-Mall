...
<div id="main">
    ...
    <form name=alipayment action=/order/goAlipay.action method=post
          target="_blank">
...
<script language="javascript">
    ...
    function GetDateNow() {
        document.getElementById("WIDout_trade_no").value = "${orders_Id}";
        document.getElementById("WIDsubject").value = "甜品店零食";
